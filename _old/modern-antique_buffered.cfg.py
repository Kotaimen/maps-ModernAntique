...
def make_filesystem_source_config(root, default=None, border_color='transparent'):
    return {
        'prototype': 'storage',
...
#         (
        ...
        ########## Sea monsters            
        ( $15 -spread 1 -fill #6a3b30 -colorize 100% ) -compose Hardlight -composite        
        ...
        (
            (
                (
                    $6 
                    -brightness-contrast -11%x-60%  -gamma 1.1 -unsharp 0x0.3
                )
                (
                    $7 
                    -brightness-contrast 0%x-8% -fill #d1af4d -colorize 55%
        ...
        (
            ...
            -evaluate Multiply 0.8 -gamma 1 +channel
